...
def main(args):
    ...
    # log_path = "./logs/{}/{}".format('MLP', 'control525_test52')
    # log_path = "./logs/{}/{}".format('MLP', 'control525twice_test52')
    log_path = "./logs/{}/{}".format('MLP', 'control525triple_test52')
    # log_path = "./logs/{}/{}".format('MLP', 'control525_test105')
    logger = get_logger(save_dir=log_path, fname='{}-{}-{}.log'.format(experimentID, args.csv_filename, args.seed))
